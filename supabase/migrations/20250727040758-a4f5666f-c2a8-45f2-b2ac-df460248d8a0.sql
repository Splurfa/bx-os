...
-- Fix validate_kiosk_availability function
DROP FUNCTION IF EXISTS public.validate_kiosk_availability();
...
-- Fix handle_kiosk_deactivation function
DROP FUNCTION IF EXISTS public.handle_kiosk_deactivation();
