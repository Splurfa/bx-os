-- EMERGENCY SECURITY LOCKDOWN: Implement comprehensive RLS policies (Fixed)

-- 1. STUDENTS TABLE SECURITY - Replace existing policies with secure versions
...
-- Secure student data access policies with unique names
...
-- 7. CSV IMPORT TABLE SECURITY (Super Admin only)
...
INSERT INTO user_sessions (
  ...
  'security_system',
  jsonb_build_object(
    'event_type', 'emergency_security_lockdown_completed',
    'timestamp', now(),
    'policies_secured', array['students', 'families', 'guardians', 'behavior_requests', 'reflections', 'communication_logs', 'csv_import_raw'],
    'vulnerability_count_resolved', 5,
    'security_level', 'high',
    'status', 'active'
  ),
