-- Fix premature kiosk assignment - remove status condition from availability check
...
BEGIN
  ...
  -- FIXED: Removed status = 'waiting' condition - kiosk is occupied if ANY student has kiosk_status of waiting/ready/in_progress
  ...
  LOOP
    ...
    -- FIXED: Removed status = 'waiting' condition here too
