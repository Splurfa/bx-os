...
-- Create family tracking table for processing
CREATE TEMPORARY TABLE processed_families (
...
BEGIN
  ...
  LOOP
    ...
    SELECT family_id INTO family_id FROM temp_processed_families WHERE family_key = family_key;
    ...
    IF family_id IS NULL THEN
      ...
      -- Track this family
      INSERT INTO temp_processed_families (family_key, family_id) VALUES (family_key, family_id);
