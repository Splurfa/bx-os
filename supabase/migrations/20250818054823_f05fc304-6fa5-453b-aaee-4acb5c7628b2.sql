...
BEGIN
  ...
  LOOP
    ...
    SELECT tpf.family_id INTO current_family_id FROM temp_processed_families tpf WHERE tpf.family_key = family_key;
    ...
    IF current_family_id IS NULL THEN
      ...
      -- Track this family
      INSERT INTO temp_processed_families (family_key, family_id) VALUES (family_key, current_family_id);
